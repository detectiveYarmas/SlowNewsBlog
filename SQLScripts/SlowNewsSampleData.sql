...
--blogpostscatagories
INSERT INTO BlogPostsCatagories (BlogPostId, CatagoryId)
VALUES
((SELECT BlogPostId FROM BlogPosts WHERE BlogPostId = 1),(SELECT CatagoryId FROM Catagories WHERE CatagoryId = 4)),
((SELECT BlogPostId FROM BlogPosts WHERE BlogPostId = 1),(SELECT CatagoryId FROM Catagories WHERE CatagoryId = 2)),
((SELECT BlogPostId FROM BlogPosts WHERE BlogPostId = 2),(SELECT CatagoryId FROM Catagories WHERE CatagoryId = 4)),
